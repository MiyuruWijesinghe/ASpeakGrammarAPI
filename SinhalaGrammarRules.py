...
N[NUM=sg, GEN=NE, CASE=F1, DEF=TRue]   -> 'සමාජය' | 'වෙලාව' | 'ඇග'
N[NUM=sg, GEN=NE, CASE=F1, DEF=False]   -> 'සමාජයක්' | 'වෙලාවක්' | 'ඇගක්' 
N[NUM=sg, GEN=NE, CASE=F3, DEF=TRue]   -> 'සමාජයට' | 'වෙලාවට' | 'ඇගට' 
N[NUM=sg, GEN=NE, CASE=F3, DEF=False]   -> 'සමාජයකට' | 'වෙලාවකට' | 'ඇගකට'
N[NUM=sg, GEN=NE, CASE=F4, DEF=TRue]   -> 'සමාජයේ' | 'වෙලාවේ' | 'ඇගේ' 
N[NUM=sg, GEN=NE, CASE=F4, DEF=False]   -> 'සමාජයක' | 'වෙලාවක' | 'ඇගක'
N[NUM=sg, GEN=NE, CASE=F5, DEF=TRue]   -> 'සමාජයෙන්' | 'වෙලාවෙන්' | 'ඇගෙන්'
N[NUM=sg, GEN=NE, CASE=F5, DEF=False]   -> 'සමාජයකින්' | 'වෙලාවකින්' | 'ඇගකින්'
...
IV[TENSE=Npast,  NUM=pl, VLT=True, PER=S] -> 'යනවාද' | 'කනවාද' | 'බොනවාද' | 'එනවාද' | 'ඉන්නවාද' | 'හොයනවාද' | 'සෝදනවාද' | 'කරනවාද'
...
IV[TENSE=past,  NUM=sg, VLT=True, PER=S] -> 'ගියාද' | 'කෑවාද' | 'බිව්වාද' | 'ආවාද' | 'හිටියාද' | 'හෙව්වාද' | 'සේදුවාද' | 'කරාද'
IV[TENSE=past,  NUM=pl, VLT=True, PER=S] -> 'ගියාද' | 'කෑවාද' | 'බිව්වාද' | 'ආවාද' | 'හිටියාද' | 'හෙව්වාද' | 'සේදුවාද' | 'කරාද'
...
TV[TENSE=Npast,  NUM=sg, VLT=True, PER=S] -> 'යනවාද' | 'කනවාද' | 'බොනවාද' | 'එනවාද' | 'ඉන්නවාද' | 'හොයනවාද' | 'සෝදනවාද' | 'කරනවාද'
TV[TENSE=Npast,  NUM=pl, VLT=True, PER=S] -> 'යනවාද' | 'කනවාද' | 'බොනවාද' | 'එනවාද' | 'ඉන්නවාද' | 'හොයනවාද' | 'සෝදනවාද' | 'කරනවාද'
...
TV[TENSE=past,  NUM=sg, VLT=True, PER=S] -> 'ගියාද' | 'කෑවාද' | 'බිව්වාද' | 'ආවාද' | 'හිටියාද' | 'හෙව්වාද' | 'සේදුවාද' | 'කරාද'
TV[TENSE=past,  NUM=pl, VLT=True, PER=S] -> 'ගියාද' | 'කෑවාද' | 'බිව්වාද' | 'ආවාද' | 'හිටියාද' | 'හෙව්වාද' | 'සේදුවාද' | 'කරාද'
