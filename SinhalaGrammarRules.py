...
IV[TENSE=Npast,  NUM=sg, GEN=MA, VLT=True, PER=T] -> 'යනවා' | 'කනවා' | 'බොනවා' 
IV[TENSE=Npast,  NUM=sg, GEN=FE, VLT=True, PER=T] -> 'යනවා' | 'කනවා' | 'බොනවා'
IV[TENSE=Npast,  NUM=sg, GEN=MA, VLT=False, PER=T] -> 'යනවා' | 'කනවා' | 'බොනවා'
IV[TENSE=Npast,  NUM=sg, GEN=NE, VLT=False, PER=T] -> 'යනවා' | 'කනවා' | 'බොනවා'
IV[TENSE=Npast,  NUM=pl, VLT=True, PER=T] -> 'යනවා' | 'කනවා' | 'බොනවා'
IV[TENSE=Npast,  NUM=sg, VLT=True, PER=S] -> 'යන්න' | 'කන්න' | 'බොන්න'
IV[TENSE=Npast,  NUM=pl, VLT=True, PER=S] -> 'යනවාද' | 'කනවාද' | 'බොනවාද'
IV[TENSE=Npast,  NUM=sg, VLT=True, PER=F] -> 'යනවා' | 'යන්නම්' | 'කනවා' | 'කන්නම්' | 'බොනවා' | 'බොන්නම්'
IV[TENSE=Npast,  NUM=pl, VLT=True, PER=F] -> 'යමු' | 'යනවා' | 'යන්නම්' | 'කමු' | 'කනවා' | 'කන්නම්' | 'බොනවා' | 'බොන්නම්'

IV[TENSE=past,  NUM=sg, GEN=MA, VLT=True, PER=T] -> 'ගියා' | 'කෑවා' | 'බිව්වා' 
IV[TENSE=past,  NUM=sg, GEN=FE, VLT=True, PER=T] -> 'ගියා' | 'කෑවා' | 'බිව්වා' 
IV[TENSE=past,  NUM=sg, VLT=False, PER=T] -> 'ගියා' | 'කෑවා' | 'බිව්වා' 
IV[TENSE=past,  NUM=pl, VLT=True, PER=T] -> 'ගියා' | 'කෑවා' | 'බිව්වා' 
IV[TENSE=past,  NUM=sg, VLT=True, PER=S] -> 'ගියාද' | 'කෑවාද' | 'බිව්වාද'  
IV[TENSE=past,  NUM=pl, VLT=True, PER=S] -> 'ගියාද' | 'කෑවාද' | 'බිව්වාද'
IV[TENSE=past,  NUM=sg, VLT=True, PER=F] -> 'ගියා' | 'කෑවා' | 'බිව්වා' 
IV[TENSE=past,  NUM=pl, VLT=True, PER=F] -> 'ගියා' | 'කෑවා' | 'බිව්වා' 

TV[TENSE=Npast,  NUM=sg, GEN=MA, VLT=True, PER=T] -> 'යයි' | 'කයි' | 'බොයි'
TV[TENSE=Npast,  NUM=sg, GEN=FE, VLT=True, PER=T] -> 'යයි' | 'කයි' | 'බොයි'
TV[TENSE=Npast,  NUM=sg, VLT=False] -> 'යනවා' | 'කනවා' | 'බොනවා'
TV[TENSE=Npast,  NUM=pl, VLT=False] -> 'යනවා' | 'කනවා' | 'බොනවා'
TV[TENSE=Npast,  NUM=pl, VLT=True, PER=T] -> 'යනවා' | 'කනවා' | 'බොනවා'
TV[TENSE=Npast,  NUM=sg, VLT=True, PER=S] -> 'යනවාද' | 'කනවාද' | 'බොනවාද'
TV[TENSE=Npast,  NUM=pl, VLT=True, PER=S] -> 'යනවාද' | 'කනවාද' | 'බොනවාද'
TV[TENSE=Npast,  NUM=sg, VLT=True, PER=F] -> 'යනවා' | 'යන්නම්' | 'කනවා' | 'කන්නම්' | 'බොනවා' | 'බොන්නම්'
TV[TENSE=Npast,  NUM=pl, VLT=True, PER=F] -> 'යමු' | 'යනවා' | 'යන්නම්' | 'කමු' | 'කනවා' | 'කන්නම්' | 'බොමු' | 'බොනවා' | 'බොන්නම්'

TV[TENSE=past,  NUM=sg, GEN=MA, VLT=True, PER=T] -> 'ගියා' | 'කෑවා' | 'බිව්වා'  
TV[TENSE=past,  NUM=sg, GEN=FE, VLT=True, PER=T] -> 'ගියා' | 'කෑවා' | 'බිව්වා'  
TV[TENSE=past,  NUM=sg, GEN=MA, VLT=False, PER=T] -> 'ගියා' | 'කෑවා' | 'බිව්වා'  
TV[TENSE=past,  NUM=pl, VLT=True, PER=T] -> 'ගියා' | 'කෑවා' | 'බිව්වා'  
TV[TENSE=past,  NUM=sg, VLT=True, PER=S] -> 'ගියාද' | 'කෑවාද' | 'බිව්වාද'  
TV[TENSE=past,  NUM=pl, VLT=True, PER=S] -> 'ගියාද' | 'කෑවාද' | 'බිව්වාද'  
TV[TENSE=past,  NUM=sg, VLT=True, PER=F] -> 'ගියා' | 'කෑවා' | 'බිව්වා'  
TV[TENSE=past,  NUM=pl, VLT=True, PER=F] -> 'ගියා' | 'කෑවා' | 'බිව්වා'  
