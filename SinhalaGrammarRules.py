...
IV[TENSE=Npast,  NUM=sg, GEN=MA, VLT=True, PER=T] -> 'යනවා' | 'කනවා' 
IV[TENSE=Npast,  NUM=sg, GEN=FE, VLT=True, PER=T] -> 'යනවා' | 'කනවා' 
IV[TENSE=Npast,  NUM=sg, GEN=MA, VLT=False, PER=T] -> 'යනවා' | 'කනවා' 
IV[TENSE=Npast,  NUM=sg, GEN=NE, VLT=False, PER=T] -> 'යනවා' | 'කනවා' 
IV[TENSE=Npast,  NUM=pl, VLT=True, PER=T] -> 'යනවා' | 'කනවා' 
IV[TENSE=Npast,  NUM=sg, VLT=True, PER=S] -> 'යන්න' | 'කන්න' 
IV[TENSE=Npast,  NUM=pl, VLT=True, PER=S] -> 'යනවාද' | 'කනවාද' 
IV[TENSE=Npast,  NUM=sg, VLT=True, PER=F] -> 'යනවා' | 'යන්නම්' | 'කනවා' | 'කන්නම්' 
IV[TENSE=Npast,  NUM=pl, VLT=True, PER=F] -> 'යමු' | 'යනවා' | 'යන්නම්' | 'කමු' | 'කනවා' | 'කන්නම්' 

IV[TENSE=past,  NUM=sg, GEN=MA, VLT=True, PER=T] -> 'ගියා' | 'කෑවා' 
IV[TENSE=past,  NUM=sg, GEN=FE, VLT=True, PER=T] -> 'ගියා' | 'කෑවා' 
IV[TENSE=past,  NUM=sg, VLT=False, PER=T] -> 'ගියා' | 'කෑවා' 
IV[TENSE=past,  NUM=pl, VLT=True, PER=T] -> 'ගියා' | 'කෑවා' 
IV[TENSE=past,  NUM=sg, VLT=True, PER=S] -> 'ගියාද' | 'කෑවාද'  
IV[TENSE=past,  NUM=pl, VLT=True, PER=S] -> 'ගියාද' | 'කෑවාද' 
IV[TENSE=past,  NUM=sg, VLT=True, PER=F] -> 'ගියා' | 'කෑවා' 
IV[TENSE=past,  NUM=pl, VLT=True, PER=F] -> 'ගියා' | 'කෑවා' 

TV[TENSE=Npast,  NUM=sg, GEN=MA, VLT=True, PER=T] -> 'යයි' | 'කයි'
TV[TENSE=Npast,  NUM=sg, GEN=FE, VLT=True, PER=T] -> 'යයි' | 'කයි'
TV[TENSE=Npast,  NUM=sg, VLT=False] -> 'යනවා' | 'කනවා' 
TV[TENSE=Npast,  NUM=pl, VLT=False] -> 'යනවා' | 'කනවා' 
TV[TENSE=Npast,  NUM=pl, VLT=True, PER=T] -> 'යනවා' | 'කනවා' 
TV[TENSE=Npast,  NUM=sg, VLT=True, PER=S] -> 'යනවාද' | 'කනවාද' 
TV[TENSE=Npast,  NUM=pl, VLT=True, PER=S] -> 'යනවාද' | 'කනවාද' 
TV[TENSE=Npast,  NUM=sg, VLT=True, PER=F] -> 'යනවා' | 'යන්නම්' | 'කනවා' | 'කන්නම්'  
TV[TENSE=Npast,  NUM=pl, VLT=True, PER=F] -> 'යමු' | 'යනවා' | 'යන්නම්' | 'කමු' | 'කනවා' | 'කන්නම්' 

TV[TENSE=past,  NUM=sg, GEN=MA, VLT=True, PER=T] -> 'ගියා' | 'කෑවා'  
TV[TENSE=past,  NUM=sg, GEN=FE, VLT=True, PER=T] -> 'ගියා' | 'කෑවා'  
TV[TENSE=past,  NUM=sg, GEN=MA, VLT=False, PER=T] -> 'ගියා' | 'කෑවා'  
TV[TENSE=past,  NUM=pl, VLT=True, PER=T] -> 'ගියා' | 'කෑවා'  
TV[TENSE=past,  NUM=sg, VLT=True, PER=S] -> 'ගියාද' | 'කෑවාද'  
TV[TENSE=past,  NUM=pl, VLT=True, PER=S] -> 'ගියාද' | 'කෑවාද'  
TV[TENSE=past,  NUM=sg, VLT=True, PER=F] -> 'ගියා' | 'කෑවා'  
TV[TENSE=past,  NUM=pl, VLT=True, PER=F] -> 'ගියා' | 'කෑවා'  
