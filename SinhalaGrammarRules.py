...
N[NUM=sg, GEN=MA, CASE=F1, DEF=TRue]   ->  'මිනිසා' | 'හොරා' | 'ළමයා'
N[NUM=sg, GEN=MA, CASE=F1, DEF=False]   -> 'මිනිසෙක්' | 'හොරෙක්' | 'ළමයෙක්' | 'බල්ලෙක්'
N[NUM=sg, GEN=MA, CASE=F2, DEF=TRue]   -> 'බල්ලා' | 'බුදුන්' 
N[NUM=sg, GEN=MA, CASE=F3, DEF=TRue]   -> 'මිනිසාට' | 'හොරාට' | 'ළමයාට' | 'බල්ලාට'
N[NUM=sg, GEN=MA, CASE=F3, DEF=False]   -> 'මිනිසෙක්ට' | 'හොරෙක්ට' | 'ළමයෙක්ට' | 'බල්ලෙක්ට'
N[NUM=sg, GEN=MA, CASE=F4, DEF=TRue]   -> 'මිනිසාගේ' | 'හොරාගේ' | 'ළමයාගේ' | 'බල්ලාගේ'
N[NUM=sg, GEN=MA, CASE=F4, DEF=False]   -> 'මිනිසෙක්ගේ' | 'හොරෙක්ගේ' | 'ළමයෙක්ගේ' | 'බල්ලෙක්ගේ'
N[NUM=sg, GEN=MA, CASE=F5, DEF=TRue]   -> 'මිනිසාගෙන්' | 'හොරාගෙන්' | 'ළමයාගෙන්' | 'බල්ලාගෙන්'
N[NUM=sg, GEN=MA, CASE=F5, DEF=False]   -> 'මිනිසෙක්ගෙන්' | 'හොරෙක්ගෙන්' | 'ළමයෙක්ගෙන්' | 'බල්ලෙක්ගෙන්'
...
N[NUM=sg, GEN=NE, CASE=F1, DEF=TRue]   -> 'සමාජය' | 'වෙලාව' | 'ඇග' | 'ගෙදර' | 'නම' | 'දිනය' | 'වතුර'
N[NUM=sg, GEN=NE, CASE=F1, DEF=False]   -> 'සමාජයක්' | 'වෙලාවක්' | 'ඇගක්' | 'ගෙදරක්' | 'නමක්' | 'දිනයක්' | 'වතුරක්'
N[NUM=sg, GEN=NE, CASE=F3, DEF=TRue]   -> 'සමාජයට' | 'වෙලාවට' | 'ඇගට' | 'ගෙදරට' | 'නමට' | 'දිනයට' | 'වතුරට'
N[NUM=sg, GEN=NE, CASE=F3, DEF=False]   -> 'සමාජයකට' | 'වෙලාවකට' | 'ඇගකට' | 'ගෙදරකට' | 'නමකට' | 'දිනයකට' | 'වතුරකට'
N[NUM=sg, GEN=NE, CASE=F4, DEF=TRue]   -> 'සමාජයේ' | 'වෙලාවේ' | 'ඇගේ' | 
N[NUM=sg, GEN=NE, CASE=F4, DEF=False]   -> 'සමාජයක' | 'වෙලාවක' | 'ඇගක' | 'ගෙදරක' | 'නමක' | 'දිනක' | 'වතුරක'
N[NUM=sg, GEN=NE, CASE=F5, DEF=TRue]   -> 'සමාජයෙන්' | 'වෙලාවෙන්' | 'ඇගෙන්' | 'ගෙදරෙන්' | 'නමෙන්' | 'දිනෙන්' | 'වතුරෙන්'
N[NUM=sg, GEN=NE, CASE=F5, DEF=False]   -> 'සමාජයකින්' | 'වෙලාවකින්' | 'ඇගකින්' | 'ගෙදරකින්' | 'නමකින්' | 'දිනකින්' | 'වතුරින්'
N[NUM=pl, GEN=MA, CASE=F1]   -> 'මිනිස්සු' | 'හොරු' | 'ළමයි' | 'බල්ලෝ'
N[NUM=pl, GEN=MA, CASE=F2]   -> 'මිනිසුන්' | 'හොරුන්' | 'ළමයින්' | 'බල්ලන්'
N[NUM=pl, GEN=MA, CASE=F3]   -> 'මිනිසුන්ට' | 'හොරුන්ට' | 'ළමයින්ට' | 'බල්ලන්ට' 
N[NUM=pl, GEN=MA, CASE=F4]   -> 'මිනිසුන්ගේ' | 'හොරුන්ගේ' | 'ළමයින්ගේ' | 'බල්ලන්ගේ'
N[NUM=pl, GEN=MA, CASE=F5]   -> 'මිනිසුන්ගෙන්' | 'හොරුන්ගෙන්' | 'ළමයින්ගෙන්' | 'බල්ලන්ගෙන්'
...
IV[TENSE=Npast,  NUM=pl, VLT=True, PER=S] -> 'යනවාද' | 'කනවාද' | 'බොනවාද' | 'එනවාද' | 'ඉන්නවාද' | 'හොයනවාද' | 'සෝදනවාද' | 'කරනවාද' | 'කොහෙද' | 'කාගෙද' | 'මොකක්ද' | 'කවද්ද'
...
IV[TENSE=past,  NUM=sg, VLT=True, PER=S] -> 'ගියාද' | 'කෑවාද' | 'බිව්වාද' | 'ආවාද' | 'හිටියාද' | 'හෙව්වාද' | 'සේදුවාද' | 'කරාද' | 'කොහෙද' | 'කාගෙද' | 'මොකක්ද' | 'කවද්ද'
IV[TENSE=past,  NUM=pl, VLT=True, PER=S] -> 'ගියාද' | 'කෑවාද' | 'බිව්වාද' | 'ආවාද' | 'හිටියාද' | 'හෙව්වාද' | 'සේදුවාද' | 'කරාද' | 'කොහෙද' | 'කාගෙද' | 'මොකක්ද' | 'කවද්ද'
...
TV[TENSE=Npast,  NUM=sg, VLT=True, PER=S] -> 'යනවාද' | 'කනවාද' | 'බොනවාද' | 'එනවාද' | 'ඉන්නවාද' | 'හොයනවාද' | 'සෝදනවාද' | 'කරනවාද' | 'කොහෙද' | 'කාගෙද' | 'මොකක්ද' | 'කවද්ද'
TV[TENSE=Npast,  NUM=pl, VLT=True, PER=S] -> 'යනවාද' | 'කනවාද' | 'බොනවාද' | 'එනවාද' | 'ඉන්නවාද' | 'හොයනවාද' | 'සෝදනවාද' | 'කරනවාද' | 'කොහෙද' | 'කාගෙද' | 'මොකක්ද' | 'කවද්ද'
...
TV[TENSE=past,  NUM=sg, VLT=True, PER=S] -> 'ගියාද' | 'කෑවාද' | 'බිව්වාද' | 'ආවාද' | 'හිටියාද' | 'හෙව්වාද' | 'සේදුවාද' | 'කරාද' | 'කොහෙද' | 'කාගෙද' | 'මොකක්ද' | 'කවද්ද'
TV[TENSE=past,  NUM=pl, VLT=True, PER=S] -> 'ගියාද' | 'කෑවාද' | 'බිව්වාද' | 'ආවාද' | 'හිටියාද' | 'හෙව්වාද' | 'සේදුවාද' | 'කරාද' | 'කොහෙද' | 'කාගෙද' | 'මොකක්ද' | 'කවද්ද'
